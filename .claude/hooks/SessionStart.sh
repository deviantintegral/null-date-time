...
if [ ! -f "infection.phar" ]; then
    ...
    wget https://github.com/infection/infection/releases/download/0.35.0/infection.phar
    wget https://github.com/infection/infection/releases/download/0.35.0/infection.phar.asc

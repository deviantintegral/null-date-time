...
if [ ! -f "infection.phar" ]; then
    ...
    wget https://github.com/infection/infection/releases/download/0.35.1/infection.phar
    wget https://github.com/infection/infection/releases/download/0.35.1/infection.phar.asc
